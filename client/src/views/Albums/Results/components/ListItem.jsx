  ...
  return (
    <div key={id} className="flex w-full mt-3 justify-center" >
     ...
     <div className="w-5/6 flex flex-col items-start px-4">
      <button className="font-lato sm:text-xl text-sm font-bold text-white capitalize p-4 fancybutton max-w-sm" onClick={handleListItemClick}>{title ?? "Sin titulo"}</button>
